...
const ProjectsPage = (): ReactElement => {
  ...
  return (
    ...
    >
      <h2 style={{textAlign: 'center'}}>This Page Is Under Construction. Come Back Soon!</h2>
      <div id="84cc166b-9f98-4640-a2cb-6db8b28bfe0d" key="84cc166b-9f98-4640-a2cb-6db8b28bfe0d"></div>
    </StandardLayout>
  );
};
