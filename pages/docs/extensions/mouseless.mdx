...
- `Alt-Ctrl-Shift-Z` - Collapse block tree to a certain level, specified by the following numeric key press
- `Alt-Ctrl-Shift-X` - Expand block tree to a certain level, specified by the following numeric key press
