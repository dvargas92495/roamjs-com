...
- `Alt-Ctrl-Shit-A` - Replace last reference before cursor with text and alias
- `Alt-Ctrl-Shit-C` - Apply children as text
- `Alt-Ctrl-Shit-O` - Rreplace with original + bring nested items along
- `Alt-Ctrl-Shit-M` - Create Comment (coming soon)
