...
loom: 1ec89866715e402ea590e8420700ad76
contributors: Elizabeth Brott Beese 💵📓
---
...
- Copy block refs - Hitting CTRL+Shift+C (Windows) or CMD+Shift+C (Mac) will copy the references of the non consecutively selected blocks.
- Merge blocks - Hitting CTRL+Shift+M (Windows) or CMD+Shift+M (Mac) will merge the text content of the blocks into one block.
