...
- `Daily Note Secondary` - (Optional) The default sort to use on non-daily note pages when you sort by daily note. Valid values include `Page Title` and `Page Title Descending`. 
